...
object getRestaurants {
  def main(args: Array[String]) = {
    ...
    var df = sqlContext.read
      ...
      .load("C:\\Users\\Students07\\Desktop\\Project BigData\\yelp_dataset_challenge_academic_dataset\\yelp_academic_dataset_business.csv")
    ...
    df = sqlContext.read
      .format("com.databricks.spark.csv")
      .load("C:\\Users\\Students07\\Desktop\\Project BigData\\yelp_dataset_challenge_academic_dataset\\yelp_academic_dataset_tip.csv")
